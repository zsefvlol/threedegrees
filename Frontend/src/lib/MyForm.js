...
export default class MyForm extends Component {
  ...
  getValues = (nextProps) => {
    let defaults = this.state.values;
    let props = nextProps || this.props;
    props.schema.forEach((section,index)=>{
  ...
  componentWillReceiveProps = this.getValues;
          ...
          return (
            <Cell key={i} className={this.getErrorStyle(item.id,sectionIndex)}>
              <CellBody>
                ...
                value={this.state.values[item.id]}></textarea>
              </CellBody>
            </Cell>
          )
          break;
          ...
          return(
            <label key={i} className="weui_cell weui_check_label">
                <div className="weui_cell_hd">
                    <input type="checkbox" className="weui_check" checked={this.state.values[item.id]}
                      onChange={this.itemOnChange.bind(this,item.type,item.id)} />
